...
export const metadata: Metadata = {
  title: 'Next.js + Prisma starter (with design system)',
  description:
    ...
    >
      <head>
        {/*
          ...
          the standard theme-init pattern (see next-themes and shadcn/ui)
          and is XSS-safe because the script content is fixed.
        */}
