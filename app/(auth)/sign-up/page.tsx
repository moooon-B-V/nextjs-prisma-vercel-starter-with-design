 ...
 * email localpart at create-time and let the user edit it later in a
 * profile-settings surface (not included in this starter). If you want
 * to ask for a name at signup, add an Input above the Email field here
 * and pass its value to `signUp.email({ ..., name })` below.
 *
 * Errors:
...
function SignUpShell() {
  return (
    <AuthShell headline="Create your account" subhead="Sign up to get started.">
