 ...
 * background.
 *
 * Wordmark is intentionally absent. Add your own brand mark to this
 * layout once you have one — until then, shipping without placeholder
 * branding avoids a filler element becoming load-bearing across every
 * auth screen.
 *
