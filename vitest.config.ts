...
// Browser-style component tests (jsdom/happy-dom) aren't included; if your
// app needs them later, split this into `vitest.workspace.ts` rather than
// dual-mode a single config.
