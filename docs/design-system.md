...
> patterns, voice & tone, and the don'ts. Inject this file as context into
> any prompt that generates UI — its quality directly determines the
> visual consistency of every later screen.
>
...
4. [Voice & tone](#voice--tone) — how copy should read
...
<Input label="Workspace URL" addonStart={<Globe />} addonEnd=".example.com" />
...
- `status: planned | in-progress | done` — generic task/work-item lifecycle.
...
If you ship AI-driven features, say so when the system guessed or doesn't
know — don't pretend agents are oracles.

- ✅ "We picked Next.js based on 'React + Postgres' in your description.
  Wrong stack? Edit it directly."
...
"persist". Reserve domain words for your actual data model — don't sprinkle
them as decoration.
