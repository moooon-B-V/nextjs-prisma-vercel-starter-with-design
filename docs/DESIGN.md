...
> documents the actual choices baked into this starter — what we built,
> not what we took inspiration from verbatim.
...
- **Headlines default to `font-serif`** (Source Serif 4) — this is the
  intentional choice that distinguishes this system from Notion's
  all-sans approach.
...
Detailed responsive component behavior lives alongside each primitive in
[`components/ui/`](../components/ui/).

## 9. Agent Prompt Guide

**Inject this section into any prompt that generates UI built on this
design system:**
