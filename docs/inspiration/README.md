...
They are NOT this starter's design system — they are the **source material**
that informed it.
...
The actual design system lives in [`../DESIGN.md`](../DESIGN.md) — read
that to understand how to build UI. This folder is a historical record
of where the choices came from.
